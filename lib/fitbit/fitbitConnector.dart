...
import 'package:crossfit/fitbit/urls/fitbitAuthAPIURL.dart';
...
class FitbitCredentials {
  ...
  FitbitCredentials copyWith(
    ...
    String u = userID ?? this.userID;
    String fa = fitbitAccessToken ?? this.fitbitAccessToken;
    String fr = fitbitRefreshToken ?? this.fitbitRefreshToken;
